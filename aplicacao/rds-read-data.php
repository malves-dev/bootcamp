...
if ( $mode=="edit")
 ...
 method=post>
 <table>
 <tr><td>Last name:</td><td><input style="color:black" type="text" value="';
 Print $lastname;
 print '" name="lastname" /></td></tr>
 <tr><td>First name:</td><td><input style="color:black" type="text" value="';
 Print $firstname;
 print '" name="firstname" /></td></tr>
 <tr><td>Phone:</td><td><input style="color:black" type="text" value="';
 Print $phone;
